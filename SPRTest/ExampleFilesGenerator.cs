...
namespace RoboCup.AtHome.SPRTest
{
	...
	public static class ExampleFilesGenerator
	{
		...
		static void SaveGrammarFile (string name, string header, string formatSpec, string content)
		{
			...
			fileName = Loader.GetPath("spr_grammars", fileName);
		...
		{
			string path = Loader.GetPath("spr_grammars");
			...
			grammars.Add("arena_questions", Resources.ArenaQuestions);
			grammars.Add("crowd_questions", Resources.CrowdQuestions);
			grammars.Add("object_questions", Resources.ObjectQuestions);
			grammars.Add("predefined_questions", Resources.PredefinedQuestions);
